...
<div id="wrapper">
	<header class="sticky-top p-3 text-black border-bottom row" style="margin:0px;">
		<h3 class="col-11 px-0">ADMIN</h3>
		<a href="/post/insert" class="col-1 text-left text-black">+</a>
	</header>

<div class="container">

	<form action="/gallList" method="post" class="form-signin">
		<h1>갤러리 생성 페이지</h1>
		<br/>
		<div class="form-floating">
			<input type="text" class="form-control" name="gall_name" placeholder="갤러리명"/>
	      	<label for="floatingInput">갤러리명을 입력해주세요.</label>
	    </div>
	    <div class="form-floating">
			<input type="text" class="form-control" name="table_name" placeholder="테이블명(gall_?)"/>
	      	<label for="floatingPassword">테이블명을 입력해주세요. (gall_?)</label>
	    </div>
		<input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }"/><br/>
		<input type="submit"class="form-control btn-primary" value="갤러리 생성">
	</form>
